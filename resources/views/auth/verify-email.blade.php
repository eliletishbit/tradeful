        ...
        <div class="col-md-6">
            <div class="card p-4" style="border-radius: 15px; background-color: #f8f9fa; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
                <div class="mb-4 text-sm text-gray-600">
                    {{ __('Merci de vous être inscrit ! Avant de commencer, pourriez-vous vérifier votre adresse e-mail en cliquant sur le lien que nous venons de vous envoyer ? Si vous n\'avez pas reçu l\'email, nous serons ravis de vous en envoyer un autre.') }}
                </div>
